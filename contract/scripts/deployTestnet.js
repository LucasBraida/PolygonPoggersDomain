const main = async () => {
    ...
    const domainContract = await domainContractFactory.deploy('poggers', hre.ethers.utils.parseEther('0.1'));
    await domainContract.deployed();
  
    console.log("Contract deployed to:", domainContract.address);
  
    // CHANGE THIS DOMAIN TO SOMETHING ELSE! I don't want to see OpenSea full of bananas lol
    let txn = await domainContract.register("founder",  {value: hre.ethers.utils.parseEther('0.1')});
    await txn.wait();
